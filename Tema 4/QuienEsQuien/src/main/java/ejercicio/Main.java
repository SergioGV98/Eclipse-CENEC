...
public class Main {
	...
	public static void main(String[] args) {
		...
		String [] caracteristicas = {"Gafas", "Barba", "Collar", "Hombre", "Mujer", "Sombrero", "PeloMoreno", "PeloRubio",
				"OjosMarrones", "OjosVerdes", "OjosAzules"};
		
		while(personas.length > 1) {
			
			System.out.println("Personas restantes: " + Funciones.imprimeArray(personas));
				...
				switch(opcion) {
					case 1:
						...
						for(byte i = 0; i < personas.length; i++) {
							if(personas[i].contains("marta")) {
								marta = marta.replace("Mujer", "null");
							}
						}
						break;
					case 2:
			...
			System.out.println("Te voy a monstrar los restantes");
