...
public class HoraDeAventura {
	...
	public static void main(String[] args) {
		...
		//Variables
		byte opcionElegida;
		byte opcionElegida2 = 0;
		byte opcionElegida3 = 0;
		...
		if(opcionElegida == 1) {
			...
			opcionElegida2=Byte.parseByte(sc.nextLine());
		...
		//Opcion elegida 3
		if(opcionElegida == 3) {
			System.out.println("*Le metes con la bandurria en la cabeza y decides hacerte /n" + 
