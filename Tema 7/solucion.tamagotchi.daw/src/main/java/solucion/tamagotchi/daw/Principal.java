...
public class Principal {
	...
	public static void main(String[] args) {
		...
		do {
			try {
				System.out.println("Dame el valor de hambre con el que va empezar tu Tamagotchi (Si le pones un valor de menos de 30, la comida empezara automaticamente a 30)");
